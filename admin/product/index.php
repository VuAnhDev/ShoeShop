...
<body>
	<ul class="nav nav-tabs">
		<a href="../../index.php"> <button class="btn btn-primary" style="margin:10px;">Home</button></a>
	  <li class="nav-item">
...
$sql         = 'select products.id, products.title, products.price, products.thumbnail, products.updated_at, category.name category_name from products left join category on products.id_category = category.id '.' limit '.$firstIndex.', '.$limit;
